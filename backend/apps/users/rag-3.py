...
def query_rag(question: str):
    ...
    answer, source_docs, timings = generate_answer(
...
#         embedder, faiss_index = build_index(all_chunks)
    ...
    # df.to_csv("./generated_responses/llama_responses.csv", index=False)
    # print("\nSaved results (with timings) to llama_responses.csv")

...
export class GuestChatComponent implements OnInit {
  ...
  createNewChat(addToSidebar = true) {
    ...
    this.addAIMessage(
      this.currentChat,
      `Hello there!\n I'm PolyconomyAI\n I'm trained on economics research and literature.\n I can help explain concepts, discuss theories, and explore economic ideas. Please note, I provide information for understanding only and cannot offer personalised financial advice. Think of me as a guide to economic knowledge, not a decision-maker.`
    );
  }
